      ...
      <div className="container flex flex-col justify-center items-center p-20">
        ...
        >
          ...
          <div className="flex flex-col mb-5 text-sm">
            <label
              className={`font-semibold ${formik.touched.fullName && formik.errors.fullName
                  ? "text-red-danger"
                  : ""
                }`}
              htmlFor=""
          ...
          <div className="flex flex-col  mb-5 text-sm">
            <label
              className={`font-semibold ${formik.touched.email && formik.errors.email
                  ? "text-red-danger"
                  : ""
                }`}
              htmlFor=""
          ...
          <div className="flex flex-col mb-5 text-sm">
            <label
              className={`font-semibold ${formik.touched.phone && formik.errors.phone
                  ? "text-red-danger"
                  : ""
                }`}
              htmlFor=""
          ...
          <div className="flex flex-col mb-5 text-sm">
            <label
              className={`font-semibold ${formik.touched.password && formik.errors.password
                  ? "text-red-danger"
                  : ""
                }`}
              htmlFor=""
          ...
          <div className="flex flex-col mb-5 text-sm">
            <label
              className={`font-semibold ${formik.touched.cpassword && formik.errors.cpassword
                  ? "text-red-danger"
                  : ""
                }`}
              htmlFor=""
